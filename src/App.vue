...
export default {
  ...
  data: function() {
    return {
      topics: [
        {id: 1, bgColour: "#404040", title: "Dev.", titleColour: "#FABC2A", imgName: "terminals.png", flip: false, blurb: "I have been developing software for short period but problem solving has been a constant.", infoCard: null},
